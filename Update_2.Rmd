...
```{r}
# line chart
ggplot(ab.dt, aes(x=price, y= availability_365)) + geom_line()
```
...
barplot(ab.dt$calculated_host_listings_count,col="red",
...
## price vs longitude
ggplot(ab.dt) +
geom_point(aes(x = longitude, y = price), color = "tomato2", alpha = 0.5) +
...
ab1.dt <-ab.dt [, c(6,7,8,9,11,12,13)]
```
